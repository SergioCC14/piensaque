...
ActiveRecord::Schema.define(version: 20140504140258) do
  ...
  create_table "relations_tables", force: true do |t|
    t.integer  "user_id"
  ...
  add_index "tags", ["pnsq_id"], name: "index_tags_on_pnsq_id", using: :btree
